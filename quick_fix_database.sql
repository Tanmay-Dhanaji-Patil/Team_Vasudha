-- QUICK FIX: Create essential tables for smart notifications
...
-- Create basic RLS policies (allow all for now - you can tighten later)
CREATE POLICY "Allow all operations on Sowing Plans" ON "Sowing Plans" FOR ALL USING (true);
CREATE POLICY "Allow all operations on Soil Health Actions" ON "Soil Health Actions" FOR ALL USING (true);
CREATE POLICY "Allow all operations on Task Rescheduling" ON "Task Rescheduling" FOR ALL USING (true);
CREATE POLICY "Allow all operations on Smart Notifications" ON "Smart Notifications" FOR ALL USING (true);

-- Grant permissions
GRANT ALL ON "Sowing Plans" TO authenticated, anon;
GRANT ALL ON "Soil Health Actions" TO authenticated, anon;
GRANT ALL ON "Task Rescheduling" TO authenticated, anon;
GRANT ALL ON "Smart Notifications" TO authenticated, anon;
