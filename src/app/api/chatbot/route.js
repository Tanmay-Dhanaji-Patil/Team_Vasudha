 ...
 * Purpose: Provides an AI-powered conversational interface using Google Gemini.
 *          Specialized in agricultural advisory and general-purpose assistance.
 */
...
/**
 * Handles incoming chat messages and generates AI responses.
 * Implements a fallback mechanism to handle API outages or missing keys.
 */
export async function POST(request) {
  try {
    ...
    try {
      ...
      /**
       * Slidling Window Context
       * Extract the most recent turn-based history to maintain conversational 
       * coherence without exceeding token limits.
       */
      ...
      /**
       * Prompt Engineering
       * Defines the AI's persona, constraints, and operational guidelines.
       */
      const prompt = `
...
/**
 * Static Rule-Based Response Engine
 * Provides immediate feedback when the primary LLM provider is unavailable.
 * 
 * @param {string} message - Normalized user input.
 * @returns {string} - Predefined response string.
 */
function getFallbackResponse(message) {
   ...
   * Simple keyword-based routing for basic conversational continuity.
   */
